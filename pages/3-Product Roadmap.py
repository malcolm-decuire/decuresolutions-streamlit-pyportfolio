...
with tab1:
   st.header("📅 Add More Examples")
   st.write("📌 Q4'2025 add more tickers")
   st.write("📝 Enable users to upload their own data and conduct analysis")
   st.image("https://media.istockphoto.com/id/1286394077/vector/reit-real-estate-investment-trust-concept-with-keywords-people-and-icons-flat-vector.jpg?s=1024x1024&w=is&k=20&c=be77-2jAR_W1snh8FU2zQYhRAzot3D6ry6ddrXjceAM=", width=400)

with tab2:
   st.header("📅 Add More Insights")
   st.write("📌 Q1'2026 add more insights & charts")
...
with tab3:
   ...
   st.write("📌 Q2'2026 release a repo that can run locally & in the cloud")
